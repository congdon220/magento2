...
namespace Meigee\Bowtie\Preference\View;
...
class UiComponent extends \Magento\Framework\View\Layout\Reader\UiComponent
{
    ...
    public function __construct(Layout\ScheduledStructure\Helper $helper, \Meigee\Bowtie\Model\ViewCheck $viewCheck, $scopeType = null)
    {

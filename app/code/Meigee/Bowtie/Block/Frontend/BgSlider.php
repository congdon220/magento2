<?php
namespace Meigee\Bowtie\Block\Frontend;
...
class BgSlider  extends \Magento\Framework\View\Element\Template
{
    ...
    )
    {
        ...
        $this->_sliderConfig = $this->_scopeConfig->getValue('bowtie_bg_slider/bowtie_bgslider_options', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
    }
